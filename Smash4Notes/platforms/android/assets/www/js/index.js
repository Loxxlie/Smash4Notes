...
function iconClicked () {
    $.jAlert({
        'title': 'About',
        'content': '<h3 style="margin: 0px">Smash4Notes</h3><br>' +
        '<span class="about-content"><b>Author</b>: Ethan Lie<br>' +
        '<b>Website</b>: moogcode.com<br>' +
        '<b>Frame Data</b>: Aerodome & kuroganehammer.com<br><br>' +
        'Thanks to NorCal Sm4sh for the support!</span>',
        'theme': 'yellow',
        'size': 'sm'
    });
    /*if(!aboutOpen){
